...
* [nativefs](https://github.com/megagrump/nativefs) - Read and write files outside of LÖVE's allowed paths; (obsolete, please feel free to see the a clone maintained by [EngineerSmith](https://github.com/EngineerSmith/nativefs).
